/*========================================================
 ...
 Code by Nathan Gordon http://cinemont.com
 Design by Pascal Van De Haar http://www.behance.net/PascalSetSail
    ...
    var e = $("body"),
        ...
        c = function(e, t, n, r) {
            ...
            switch (e) {
                ...
                case 6:
                    ...
                    switch (true) {
                        case f < o: $("#medal").attr("src", "img/img_end.png");
                            $("#finish .score").html(f);
                            $("#finish .play-time").html(d);
                            $(".next-medal").show();
                            $(".next-medal .points").html("+" + (o - f));
                            break;
                        case f < u: $("#medal").attr("src", "img/img_end-br.png");
                            $("#finish .score").html(f);
                            $("#finish .play-time").html(d);
                            $("#finish .next-medal").show();
                            $("#finish .next-medal .points").html("+" + (u - f));
                            break;
                        case f < a: $("#medal").attr("src", "img/img_end-si.png");
                            $("#finish .score").html(f);
                            $("#finish .play-time").html(d);
                            $("#finish .next-medal").show();
                            $("#finish .next-medal .points").html("+" + (a - f));
                            break;
                        case f >= a: $("#medal").attr("src", "img/img_end-go.png");
                            $("#finish .score").html(f);
                            $("#finish .play-time").html(d);
        ...
        h = function(r) {
            var a = [],
                h = [],
                p = [],
                d = [[ - 130, 0, 130, 0], [212, -144, 177, -46, 107, -6, 34, 4, -23, 27, -10, -15, -107, -130, -178, -150, -132, -163, -115, -202, -85, -155], [147, -197, 154, -145, 136, -80, 86, -21, 0, 0, -36, 33, -81, 38, -62, -9, -107, -32, -157, -87, -184, -152, -235, -164, -222, -219, -188, -193, -166, -234, -136, -197, -147, -150, -92, -138], [ - 244, -175, -230, -86, -194, -29, -133, 5, -43, 5, -15, 18, 25, 21, 25, -20, 76, -42, 123, -66, 171, -101, 206, -130, 249, -109, 296, -118, 267, -143, 230, -162, 262, -194, 270, -234, 226, -221, 199, -197, 187, -154], [240, -20, 100, -13, 55, 30, 56, -12, 10, 30, 19, -14, -234, -13, -276, -84, -312, -87, -346, -128, -293, -125, -257, -113, -227, -125, -170, -135, -209, -88, -242, -80, -203, -47, -141, -85, -55, -170, 41, -209, 146, -208, 210, -175, 244, -105], [ - 216, 0, -268, -75, -283, -146, -279, -203, -245, -218, -75, -191, 97, -152, 213, -145, 238, -164, 243, -205, 174, -222, 154, -249, 216, -252, 245, -245, 269, -264, 332, -278, 313, -243, 278, -216, 300, -169, 302, -104, 275, -41, 208, 6, 152, 19, 173, 52, 129, 51, 80, 21, -7, 6, -110, 5]];
            var v = function() {
            ...
            var w = function() {
                ...
                var l = function(t) {
                    ...
                    p.push(n($(t).position().left + 12, $(t).position().top + 12, $(t).position().left + 12, $(t).position().top + 12, $(t).position().left + 12, $(t).position().top + 12, "#e1f6f1"));
                    var l = p[p.length - 1];
                    ...
                    $(a).each(function(t, r) {
                        $(r).on("mousedown",
                            function(t) {
                                ...
                                p.push(n($(r).position().left + 12, $(r).position().top + 12, t.pageX, t.pageY, t.pageX, t.pageY, "#e1f6f1"));
                                var c = p[p.length - 1];
        ...
        p = function() {
            ...
            var t = ["img/img_dot.png", "img/img_dot-full.png", "img/img_end.png", "img/img_end-br.png", "img/img_end-si.png", "img/img_end-go.png", "img/img_retry.png", "img/img_play-again.png"];
            ...
            $.each(t,
                function(t, a) {
                    return $("<img />").attr("src", a).error(function() {
                        if (typeof i != "undefined" && typeof i == "function") i();
                        ...
                        o = s / u;
                        if (typeof r != "undefined" && typeof r == "function") r(o)
                    })
                })
        };
